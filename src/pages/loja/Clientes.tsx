...
const Clientes = () => {
    ...
    const loadPreferences = async () => {
      if (user?.id) {
        try {
          const {
            data: perfil
          } = await supabase.from('perfis').select('preferencia_visualizacao_clientes').eq('id', user.id).single();
          if (perfil?.preferencia_visualizacao_clientes) {
            setViewMode(perfil.preferencia_visualizacao_clientes as "lista" | "grid");
          }
        } catch (error) {
  ...
  const handleAbrirNovoCliente = () => {
    navigate("/loja/clientes?modal=novo");
  };
  ...
  const handleEditarCliente = (cliente: any) => {
    navigate(`/loja/clientes?modal=editar&clienteId=${cliente.id}`);
  };
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3">
                ...
                <div className="ml-auto flex items-center gap-2">
                  <div className="flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-lg bg-muted/50 border border-border transition-all hover:shadow-sm">
                  ...
                  <div className="flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-lg bg-green-500/10 border border-green-500/20 transition-all hover:shadow-sm">
                    <div className="flex flex-col items-center">
                  ...
                  <div className="flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-lg bg-red-500/10 border border-red-500/20 transition-all hover:shadow-sm">
                    <div className="flex flex-col items-center">
                  ...
                  <div className="flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-lg bg-blue-500/10 border border-blue-500/20 transition-all hover:shadow-sm">
                    <div className="flex flex-col items-center">
                  ...
                  <div className="flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-lg bg-purple-500/10 border border-purple-500/20 transition-all hover:shadow-sm">
                    <div className="flex flex-col items-center">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-1 px-3">
                      ...
                      <span className="text-sm text-muted-foreground">de {Math.ceil(totalCount / pageSize)}</span>
                    </div>
