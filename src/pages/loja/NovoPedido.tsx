...
import { formatBRL, formatCurrency, parseCurrencyToNumber } from "@/utils/inputMasks";
...
export default function NovoPedido() {
  ...
  const handleVerCadastro = () => {
    ...
    window.open(`/loja/clientes?clienteId=${clienteSelecionado.id}`, '_blank');
  };
  ...
  const handleSalvar = async () => {
    ...
    const itens = produtosValidos.map(p => {
      ...
      const precoUnitario = parseFloat(p.preco) || 0;
      ...
      return {
        ...
        desconto: desconto,
        subtotal: subtotal,
        observacoes: `Medida: ${p.medida}, Material: ${p.material}, Acabamento: ${p.acabamento}`,
      };
    });
    ...
    <div className="flex flex-col w-full min-h-screen">
                     ...
                     <div className="space-y-4">
                      ...
                      {produto.produtoSelecionado && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                ...
                                atualizarProduto(produto.id, "medida", valor);
                              }}
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              <Label>Arte Final/Acabamentos</Label>
                              <span className="text-xs text-muted-foreground">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                type="text"
                                inputMode="decimal"
                                value={formatCurrency(String((parseFloat(produto.preco || '0')) * 100))}
                                onChange={(e) => {
                                  const numericValue = parseCurrencyToNumber(e.target.value);
                                  atualizarProduto(produto.id, "preco", numericValue.toString());
                                }}
                              />
                            </div>
                          </div>
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                const valor = e.target.value.slice(0, 15);
                                atualizarProduto(produto.id, "desconto", valor);
                              }}
                              placeholder="0.00"
                            />
                          </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-3xl font-bold text-primary">
                    R$ {produtos
                      ...
                      .reduce((total, p) => total + parseFloat(p.preco || "0"), 0)
                            ...
                            <div className="flex items-center justify-between w-full">
                              ...
                              <div className="flex items-center gap-2">
                                <span className="font-semibold text-sm text-primary">
                                  R$ {parseFloat(produto.preco || "0").toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                </span>
                                <ChevronDown 
                                  className={cn(
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-sm border-t p-4 z-[50] shadow-lg">
        <div className="max-w-[1800px] mx-auto flex justify-end gap-3">
          <Button variant="outline" onClick={() => navigate("/loja/inicio")} className="min-w-[120px]">
            Cancelar
          </Button>
