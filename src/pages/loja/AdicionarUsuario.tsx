...
export default function AdicionarUsuario() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Generate username from nome and sobrenome (only letters, numbers, _ and -)
      const username = `${nome.toLowerCase()}_${sobrenome.toLowerCase()}`
        .normalize('NFD')
      ...
      navigate('/loja/configuracoes?tab=usuarios');
    } catch (error: any) {
          ...
          <div className="max-w-[1800px] mx-auto space-y-6">
            <div className="flex items-center gap-4">
              <Button
                variant="ghost"
                size="icon"
                onClick={() => navigate('/loja/configuracoes?tab=usuarios')}
              >
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="username"
                    value={`${nome.toLowerCase()}_${sobrenome.toLowerCase()}`
                      .normalize('NFD')
                      .replace(/[\u0300-\u036f]/g, '')
                      .replace(/[^a-z0-9_-]/g, '')
                      .replace(/\s+/g, '_')}
