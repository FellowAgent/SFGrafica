...
export default function DetalhesPedido() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Sidebar type="loja" />
      <main className="p-4 md:p-8 pb-32">{/* pb-32 para espaço da barra inferior */}
        <div className="max-w-[1600px] mx-auto">
          {/* Header */}
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <Badge
                ...
                className="px-4 py-2 text-base font-bold cursor-pointer hover:opacity-90 transition-opacity flex items-center gap-2 border-0"
                style={{
              ...
              <Card className="bg-card border-border">
                ...
                <CardContent>
                  <div className="flex items-end gap-4">
                    ...
                    {status === 'Entrega' && (
                      <div className="flex-1">
                        <p className="text-sm text-muted-foreground mb-2">Código de Entrega:</p>
                        <div className="h-10 px-3 py-2 border border-input rounded-md flex items-center bg-white text-black font-semibold">
                          {(() => {
                            const vendedor = usuarios.find(u => u.id === vendedorId);
                            if (!vendedor) return 'N/A';
                            
                            const nomeCompleto = vendedor.nome || '';
                            ...
                            const numeroSequencial = String(parseInt(pedido.numero_pedido, 10) % 1000).padStart(3, '0');
                    ...
                    itens.map((item) => (
                      ...
                      >
                        <div 
                          ...
                          onClick={() => toggleProdutoExpandido(item.id)}
                        >
                        ...
                        {produtoExpandido === item.id && (
                          <div className="border-t border-border p-4 bg-card">
                            <div className="grid grid-cols-3 gap-4 mb-4">
                              ...
                              {item.desconto > 0 && (
                                <div>
                                  <span className="text-xs text-muted-foreground block mb-1">Desconto</span>
                                  <span className="text-sm text-foreground font-medium">
                            ...
                            {item.observacoes && (
                              <div className="mb-4">
                                ...
                                <span className="text-sm text-foreground">{item.observacoes}</span>
                              </div>
                            )}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-sm border-t border-border py-6 px-6 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto flex justify-between items-center gap-4">
          ...
          <div className="flex gap-3">
            <Button
              onClick={() => navigate(`/loja/checkout/${id}`)}
              className="px-8"
            >
              CHECKOUT
            </Button>
