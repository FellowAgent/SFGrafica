...
const systemPages = [
  ...
  { id: 'inicio', label: 'Início', path: '/loja/inicio', file: 'src/pages/loja/Inicio.tsx', position: { x: 300, y: 0 } },
  { id: 'clientes', label: 'Clientes', path: '/loja/clientes', file: 'src/pages/loja/Clientes.tsx', position: { x: 600, y: 0 } },
  { id: 'produtos', label: 'Produtos', path: '/loja/produtos', file: 'src/pages/loja/produtos/Produtos.tsx', position: { x: 300, y: 200 } },
  { id: 'categorias', label: 'Categorias', path: '/loja/categorias', file: 'src/pages/loja/produtos/Categorias.tsx', position: { x: 600, y: 200 } },
  { id: 'novo-pedido', label: 'Novo Pedido', path: '/loja/novo-pedido', file: 'src/pages/loja/NovoPedido.tsx', position: { x: 0, y: 200 } },
  { id: 'financeiro', label: 'Financeiro', path: '/loja/financeiro', file: 'src/pages/loja/Financeiro.tsx', position: { x: 0, y: 400 } },
  { id: 'configuracoes', label: 'Configurações', path: '/loja/configuracoes', file: 'src/pages/loja/Configuracoes.tsx', position: { x: 300, y: 400 } },
  { id: 'minha-conta', label: 'Minha Conta', path: '/loja/minha-conta', file: 'src/pages/loja/MinhaConta.tsx', position: { x: 600, y: 400 } },
  { id: 'checkout', label: 'Checkout', path: '/loja/checkout', file: 'src/pages/loja/Checkout.tsx', position: { x: 900, y: 200 } },
  { id: 'detalhes-pedido', label: 'Detalhes Pedido', path: '/loja/pedido/:id', file: 'src/pages/loja/DetalhesPedido.tsx', position: { x: 900, y: 0 } },
  { id: 'adicionar-usuario', label: 'Adicionar Usuário', path: '/loja/adicionar-usuario', file: 'src/pages/loja/AdicionarUsuario.tsx', position: { x: 900, y: 400 } },
  { id: 'editar-usuario', label: 'Editar Usuário', path: '/loja/editar-usuario/:id', file: 'src/pages/loja/EditarUsuario.tsx', position: { x: 1200, y: 400 } },
