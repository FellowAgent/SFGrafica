...
const SelectTrigger = React.forwardRef<
  ...
  SelectTriggerProps
>(({ className, children, onClear, showClear, state = "default", ...props }, ref) => (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        {showClear && onClear ? (
          <button
            type="button"
            className="ml-auto mr-0 h-4 w-4 opacity-50 hover:opacity-100"
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              onClear();
          ...
          <ChevronDown className="ml-auto mr-0 h-4 w-4 opacity-50" />
        )}
